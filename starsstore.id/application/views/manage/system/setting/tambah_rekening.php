<div class="page-title">
  <h3><i class="glyphicon glyphicon-user"></i> Tambah Rekening
    <?php 
...
<?php echo form_open_multipart('trueaccon2194/setting/add_rekening')?>
                    ...
                    <div class="post-inv">                                        
                        <div class="row">
                            <div class="col-md-6 col-xs-12 input group">
                              ...
                              <input type="text" name="bank_name" class="form-control cek_ecom" placeholder="Nama Bank" required>
                            ...
                            <div class="col-md-6 col-xs-12 input group">
                              <label>Code Network :<i style="color:red;">*</i></label>
                                <input type="number" name="code_network" class="form-control cek_stat" placeholder="Code Network Bank" required>
                              <br>
                            </div>
                            <div class="col-md-6 input group">
                              <label>Bank Cabang :</label>
                              <input type="text" name="cabang" class="form-control cek_kota" id="retail" placeholder="Bank Cabang" required>
                              <br>
                            </div>
                            <div class="col-md-6 input group">
                              <label>No. Rekening :</label>
                              <input type="number" name="no_rek" class="form-control cek_retail nm" id="user" placeholder="Nomor Rekening" required>
                              <br>
                            </div>
                             <div class="col-md-12 input group">
                              <label>Atas Nama :</label>
                              <input type="text" name="a_n" class="form-control cek_odv nm" id="user" placeholder="Nomor Rekening" required>
                              <br>
                            </div>
                        </div>                                        
  ...
  <div class="col-md-3 col-xs-12">
    <div class="panel panel-primary" style="border-color:#d3d3d3;">
        ...
        <div class="panel-body" style="box-shadow:0px 0px 8px 0px #bababa;">
          ...
          <button type="submit" class="btn btn-success" onclick="simpan_promo()">Simpan Rekening</button>
          <?php echo br(2)?>
      </div>
      </div>
  </div>
