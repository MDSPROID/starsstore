...
<?php echo form_open_multipart('trueaccon2194/setting/add_toko')?>
                    ...
                    <div class="post-inv">                                        
                        <div class="row">
                            <div class="col-md-6 col-xs-12 input group">
                              ...
                              <input type="text" name="akun" class="form-control cek_ecom" placeholder="Nama akun" required>
                            ...
                            <div class="col-md-6 col-xs-12 input group">
                              <label>Link :<i style="color:red;">*</i></label>
                                <input type="text" name="link" class="form-control cek_stat" placeholder="Link" required>
                              <br>
                            </div>
                            <div class="col-md-6 input group">
                              <label>Keterangan :</label>
                              <input type="text" name="keterangan" class="form-control cek_kota" id="retail" placeholder="Keterangan" required>
                              <br>
                            </div>
                            <div class="col-md-6 input group">
