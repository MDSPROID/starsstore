...
<?php echo form_open('trueaccon2194/setting/update_halaman');?>
                              ...
                              <div class="col-md-12 col-xs-12 input group">
                                  ...
                                  <select name="kat" class="form-control" required="">
                                    <?php foreach($kat as $t){
                                      if($t->id_kategori_halaman == $d['id_kategori']){
                                    ?>
                                    <option selected value="<?php echo $t->id_kategori_halaman?>"><?php echo $t->kategori?></option>
                                    <?php }else{?>
                                  ...
                                  <input type="hidden" name="ilamanpost" value="<?php $a = $this->encrypt->encode($d['id_page']);$b = base64_encode($a); echo $b; ?>">
                                  <br>
                              </div>
                              <div class="col-md-12 col-xs-12 input group">
                                  <label>Judul :<i style="color:red;">*</i></label>
                                  <input type="text" value="<?php echo $d['judul']?>" name="judul" class="form-control" placeholder="Judul" required>
                                  <br>
                              </div>
                              <div class="col-md-12 col-xs-12 input group">
                                  <label>Meta Key :<i style="color:red;">*</i></label>
                                  <input type="text" value="<?php echo $d['meta_key']?>" name="meta_key" class="form-control" placeholder="Meta Key" required>
                                  <br>
                              </div>
                              <div class="col-md-12 col-xs-12 input group">
                                  <label>Meta Description :<i style="color:red;">*</i></label>
                                  <input type="text" value="<?php echo $d['meta_desc']?>" name="meta_desc" class="form-control" placeholder="Meta Deskripsi" required>
                                  <br>
                              </div>
                              <div class="col-md-12 col-xs-12 input group">
                                  <label>Slug :<i style="color:red;">*</i></label>
                                  <input type="text" value="<?php echo $d['slug']?>" name="slug" class="form-control" placeholder="Slug" required>
                                  <br>
                              </div>
                              <div class="col-md-12 col-xs-12 input group">
                                  <label>Konten :<i style="color:red;">*</i></label>
                                  <textarea name="konten" id="mytextarea1"><?php echo $d['konten']?></textarea>
                                  <br>
                              </div>
                        </div>                                        
  ...
  <div class="col-md-3 col-xs-12">
    <div class="panel panel-primary" style="border-color:#d3d3d3;">
        ...
        <div class="panel-body" style="box-shadow:0px 0px 8px 0px #bababa;">
          ...
          <button type="submit" class="btn btn-success" onclick="simpan_promo()">Update Halaman</button>
          <?php echo br(2)?>
      </div>
      </div>
  </div>
