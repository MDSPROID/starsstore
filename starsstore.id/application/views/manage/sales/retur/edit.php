...
<div id="main-wrapper">
  <div class="row">
    <div class="col-md-9">          
      ...
      <?php echo br(3);?>
      <?php echo form_open_multipart('trueaccon2194/retur/update_retur', array('id'=>'form_produk_add'));?>
      <div class="tab-content" style="padding: 10px;box-shadow:0px 0px 8px 0px #bababa;">
        <div id="general" class="tab-pane fade in active">
            <div class="row">
              <div class="col-md-6 col-xs-12 input group">
                <label>Kode Retur : </label>
                <input type="text" style="font-weight: bold;" name="kode_retur" readonly="readonly" value="<?php echo $g['id_retur_info'];?>" class="form-control cek_slug" id="slug" placeholder="ID Retur" required>
                <br>
              </div>
              <div class="col-md-6 col-xs-12 input group ">
                <label>Tanggal Retur : <i style="color:red;">*</i></label>
                <div id="datetimepicker1" class="input-append">
                  <input type="text" data-format="yyyy-MM-dd" id="tgl1" name="tglretur" class="form-control cek_tgl" placeholder="Tanggal Retur" value="<?php echo $g['date_filter'];?>" required>
                  <span class="add-on">
              ...
              <div class="col-md-6 col-xs-6 input group">
                ...
                <input type="text" name="invoiceretur" value="<?php echo $g['id_invoice_real'];?>" class="form-control cek_slug" id="slug" placeholder="Invoice Yang Diretur" required>
                <br>
              </div>
              <div class="col-md-6 col-xs-6 input group">
                <label>Invoice Pengganti : </label> <i style="color:red;">diisi ketika ada invoice penggantinya</i>
                <input type="text" name="invoicepengganti" value="<?php if($g['id_invoice_pengganti'] == 0){ echo "";}else{ echo $g['id_invoice_pengganti']; }?>" class="form-control cek_slug" id="slug" placeholder="Invoice Pengganti" >
                <br>
              </div>
              <div class="col-xs-6 col-md-6">
                ...
                <div id="produkretur" class="urlmode">
                  <?php 
                    foreach($produk_retur as $p1){
                      if($p1->id_invoicepro == $g['id_invoice_real']){
                  ?>
                  <div class="toclone">
                    ...
                    <input type="text" name="produk1[]" value="<?php echo $p1->id_produk_from_order_produk?>" class="form-control cek_slug" placeholder="PRODUK DIRETUR - TULIS ARTIKEL DAN UKURAN" required>
                    <br>
                  </div>
                  <?php }}?>
                  <div class="toclone">
                    <a href="#" class="clone" style="color: green;margin-right: 5px;"><i class="glyphicon glyphicon-plus"></i></a>
                    <a href="#" class="delete" style="color: red;"><i class="glyphicon glyphicon-remove"></i></a>
                    <input type="text" name="produk1[]" class="form-control cek_slug" placeholder="PRODUK DIRETUR - TULIS ARTIKEL DAN UKURAN">
                    <br>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-xs-6">
                ...
                <div id="produkpengganti" class="urlmode">
                  <?php 
                    foreach($produk_retur as $p1){
                      if($p1->id_invoicepro == $g['id_invoice_pengganti']){
                  ?>
                  <div class="toclone">
                    <a href="#" class="clone" style="color: green;margin-right: 5px;"><i class="glyphicon glyphicon-plus"></i></a>
                    <a href="#" class="delete" style="color: red;"><i class="glyphicon glyphicon-remove"></i></a>
                    <input type="text" name="produk2[]" value="<?php echo $p1->id_produk_from_order_produk?>" class="form-control cek_slug" placeholder="PRODUK PENGGANTI - TULIS ARTIKEL DAN UKURAN" required>
                    <br>
                  </div>
                  <?php }}?>
                  <div class="toclone">
                    <a href="#" class="clone" style="color: green;margin-right: 5px;"><i class="glyphicon glyphicon-plus"></i></a>
                    <a href="#" class="delete" style="color: red;"><i class="glyphicon glyphicon-remove"></i></a>
                    <input type="text" name="produk2[]" class="form-control cek_slug" placeholder="PRODUK PENGGANTI - TULIS ARTIKEL DAN UKURAN">
                    <br>
                  </div>
                </div>
              </div>
              <div class="col-md-6 input group">
                ...
                <input type="text" name="alasan" class="form-control cek_slug" value="<?php echo $g['alasan'];?>" id="slug" placeholder="Alasan Retur" required>
                <br>
              </div>
              <div class="col-md-6 input group">
                ...
                <select class="form-control cek_nama" name="solusi" required> 
                  ...
                  <?php 
                    foreach($solusi as $data){
                      if($data['id_solusi'] == $g['solusi']){
                  ?>
                      <option selected="selected" value="<?php echo $data['id_solusi']?>"><?php echo $data['solusi_retur']?></option>    
                  <?php }else{?>
              ...
              <div class="col-md-12 input group">
                  ...
                  <textarea name="keterangan" id="mytextarea" ><?php echo $g['keterangan_solusi'];?></textarea>
                <?php echo br()?>
              </div>
            </div>
        </div>
