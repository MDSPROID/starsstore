...
<div id="main-wrapper">
  <div class="row">
    <div class="col-md-9">          
      ...
      <?php echo br(3);?>
      <?php echo form_open_multipart('trueaccon2194/voucher/update_voucher', array('id'=>'form_produk_add'));?>
        ...
        <div id="general" class="tab-pane fade in active">
            <div class="row">
              <div class="col-md-6 input group">
                ...
                <input type="text" name="nama_voucher" class="form-control cek_nama" id="slug" value="<?php echo $g['voucher_and_coupons']?>" placeholder="Nama Voucher" required>
              ...
              <div class="col-md-6 input group">
                ...
                <input type="text" name="gambar" class="form-control cek_odv" id="carfID" value="<?php echo $g['banner']?>">
              ...
              <div class="col-md-6 input group">
                ...
                <input type="text" name="keterangan" value="<?php echo $g['keterangan']?>" class="form-control cek_tags" id="slug" placeholder="Keterangan" required>
                <br>
              </div>
              <div class="col-md-6 input group">
                <label>Stok : </label> <i style="color:red;">*</i>
                <input type="number" name="stok" value="<?php echo $g['qty']?>" class="form-control cek_artikel" id="slug" placeholder="Stok" required>
                <br>
              </div>
              <div class="col-md-6 input group">
                ...
                <input type="text" name="action" value="<?php echo $g['action']?>" class="form-control cek_retail" id="slug" placeholder="Action" >
                <br>
              </div>
              <div class="col-md-6 input group ">
              <label>Masa Berlaku : <i style="color:red;">*</i></label>
              <div id="datetimepicker1" class="input-append">
                  <input type="text" data-format="yyyy-MM-dd" value="<?php echo $g['valid_until']?>" name="masa_berlaku" class="form-control cek_tgl" placeholder="Masa Berlaku" required>
                  <span class="add-on">
              ...
              <div class="col-md-12 input group">
                ...
                <input type="number" name="action_minim" value="<?php echo $g['action_minim_pembelanjaan']?>" class="form-control cek_retail" id="slug" placeholder="Minimal Pembelanjaan" >
                <br>
              </div>
            </div>
        </div>
