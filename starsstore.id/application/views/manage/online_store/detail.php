...
<div class="page-title">
  ...
  <div class="page-breadcrumb">
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url('trueaccon2194/online_store/')?>">Marketplace</a></li>
                            ...
                            <div class="col-md-12 col-xs-12">
                                <div class="tab-content" style="padding: 0;">
                                    ...
                                    <table cellpadding="0" cellspacing="0" class="table table-striped table-hover re_border">
                                        ...
                                        <tr style="background-color: transparent;">
                                            ...
                                            <td colspan="3" align="right" style="font-size: 12px;">
                                                ...
                                                <?php }?><br>
                                                Kode unik : <?php if($ft->kode_pembayaran == ""){ echo "-"; }else{ echo  'Rp '.$ft->kode_pembayaran;}?><br>
                                  ...
                                  <div id="track" class="tab-pane fade">
                                    <h4 style="margin-top: 0px;">No Resi : <?php echo $tge->no_resi?><br>Expedisi : <?php echo $kl->layanan?><br>Pengirim : <?php echo $kl->nama_toko;?> [<?php echo $kl->kode_edp?>]</h4>
