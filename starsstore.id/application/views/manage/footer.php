  ...
  <!-- End --> 
   ...
   <!-- respon note -->
  <div class="modal fade" id="responNote" role="dialog" style="margin-top:100px;">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <a href="javascript:void(0)" style="font-size: 30px;border-radius:inherit;padding:initial;color: black;" class="tutup_modal label" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></a>
        <h3 class="modal-title">Apa yang anda pikirkan? <span onclick="savenote();" class="label label-success">Simpan</span></h3>
      </div>
      <div class="modal-body" style="padding: 0;">
            <?php $note = note_admin();?>
            <textarea name="editor1" class="notead" id="mytextarea"><?php echo $note['konten']?></textarea>
        </div>
      </div>
    </div>
    </div>
