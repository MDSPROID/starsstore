...
<div id="main-wrapper">
  <div class="row">
    <div class="col-md-9">          
      ...
      <?php echo br(3);?>
      <?php echo form_open_multipart('trueaccon2194/customer/update_customer', array('id'=>'form_produk_add'));?>
        ...
        <div id="general" class="tab-pane fade in active">
            ...
            <?php foreach($g as $d){?>
              <div class="col-md-6 input group">
                ...
                <input type="text" name="nama" class="form-control cek_nama" id="slug" placeholder="Nama Lengkap" value="<?php echo $d->nama_lengkap?>" >
                <br>
              </div>
              <div class="col-md-6 input group">
                <label>Email : </label> <i style="color:red;">*</i>
                <input type="email" name="email" class="form-control cek_email" id="slug" placeholder="Email" value="<?php echo $d->email?>">
                <br>
              </div>
              <div class="col-md-6 input group">
                <label>Password : </label> <i style="color:red;">* isi password jika ingin mengupdate password</i>
              ...
              <div class="col-md-6 input group">
                ...
                <input type="number" name="telpon" class="form-control cek_telp" id="slug" placeholder="Nomor Telpon" value="<?php echo $d->telp?>" >
                <br>
              </div>
              <div class="col-md-6 input group">
                <label>Gambar Profil : <i style="color:red;">*</i></label><i style="color:red;">Gambar tidak diupload jika melebihi 1MB</i>
                <div class="input-group">
                <input type="text" name="gambar" class="form-control cek_kota" id="carfID" value="<?php echo $d->gb_user?>">
                <input type="hidden" name="cs" value="<?php $a = $this->encrypt->encode($d->id); $b = base64_encode($a); echo $b?>">
              ...
              <div class="col-md-12 input group">
                ...
                <input type="hidden" name="ins" value="<?php $a = $this->encrypt->encode('Hl0d!GJ5623bvhj3'); $b = base64_encode($a); echo $b?>">
                  <li><label><input type="radio" name="gender" class="form-control" value="pria" <?php echo $pria?> >Pria</label></li>
                  <li><label><input type="radio" name="gender" class="form-control" value="wanita" <?php echo $wanita?> >Wanita</label></li>
                </ul>
              <?php echo br()?>
              </div>
            <?php }?>
