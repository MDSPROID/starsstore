...
<?php 
  ...
  echo form_open('trueaccon2194/kategori_dan_parent_kategori/update_parent_kategori',$kat)?>
<div class="col-md-9">          
...
<div style="box-shadow:0px 0px 8px 0px #bababa;padding:10px;background-color:white;">
		<div class="input group">
			...
			<input type="text" name="parent_kategori" class="form-control" placeholder="Parent Kategori" value="<?php echo $updatedata['parent_kategori'];?>" required>
			<input type="hidden" name="id_parent" class="form-control" value="<?php $kat = $this->encrypt->encode($updatedata['id_parent']); $id = base64_encode($kat); echo $id?>" required>
			<br>
		</div>
    <div class="input group">
      <label>Kategori :</label>
     <select class="form-control" name="kategori">
      <?php foreach($get_master_kategori as $data){ 
        if($data['kat_id'] == $updatedata['id_kategori']){?>
      ...
      <br>
		...
		<div class="input group">
			...
			<input type="text" name="slug_parent" class="form-control" id="slug" value="<?php echo $updatedata['slug_parent'];?>" required>
			<br>
		</div>
    <div class="input group">
