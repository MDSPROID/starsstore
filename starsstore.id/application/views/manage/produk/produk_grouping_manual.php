...
<div class="page-title">
  ...
  <div class="page-breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Grouping Manual</li>
    </ol>
  </div> 
</div>
<div id="main-wrapper">
  <div class="row">
    <div class="col-md-9">          
      ...
      <?php echo br(3);?>
      <?php echo form_open_multipart('trueaccon2194/produk/create_grouping_manual', array('id'=>'form_produk_add'));?>
