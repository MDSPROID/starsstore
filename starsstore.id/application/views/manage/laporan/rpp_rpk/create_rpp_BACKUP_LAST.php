  ...
  <table id="table_produk" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%" style="box-shadow:0px 0px 8px 0px #bababa;border: 1px solid black;">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td style="text-align:center;"></td>
                  <td style="text-align:center;border-left: 5px solid black;"><?php echo number_format($total_rupiah,0,".",".")?><input type="hidden" name="total_rupiah" class="total_rupiah" value="<?php echo $total_rupiah?>"></td>
                  <td style="text-align:center;border-right: 5px solid black;">xxxxx</td>
                  <td style="text-align:center;"></td>
              </tr>
              <tr>
              ...
              <tr>
                  ...
                  <td style="text-align:center;"></td>
                  <td style="text-align:center;border-left: 5px solid black;">xxxxx</td>
                  <td style="text-align:center;border-right: 5px solid black;"><input type="number" name="biaya_pengiriman_pesanan" class="biaya_pengiriman_pesanan form-control" value="0"></td>
                  <td style="text-align:center;"></td>
              </tr>
              <tr>
                  <td style="text-align:center;">8</td>
              ...
              <tr>
                  ...
                  <td style="text-align:center;border-left: 5px solid black;">xxxxx</td>
                  <td style="text-align:center;border-right: 5px solid black;"><?php echo number_format($total_rupiah_diskon,0,".",".")?> <input type="hidden" name="spesial_diskonnnnn" class="spesial_diskon form-control" value="0"> 
                    <input type="hidden" name="ongkos_dan_administrasi_bank" class="ongkos_dan_administrasi_bank form-control" value="<?php echo $total_rupiah_diskon?>""></td>
                  <td style="text-align:center;"></td>
              </tr>
              <tr>
              ...
              <tr>
                  ...
                  <td style="text-align:center;border-left: 5px solid black;">xxxxx</td>
                  <td style="text-align:center;border-right: 5px solid black;"><input type="number" name="pembayaran_pajak" class="pembayaran_pajak form-control" value="0"></td>
                  <td style="text-align:center;"></td>
              </tr>
              <tr>
              ...
              <tr>
                  ...
                  <td style="text-align:center;border-left: 5px solid black;">xxxxx</td>
                  <td style="text-align:center;border-right: 5px solid black;"><input type="number" name="total_setoran_bank" class="form-control total_setoran_bank" value="0"></td>
                  <td style="text-align:center;"></td>
              </tr>
              <tr>
