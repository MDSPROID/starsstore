...
<script type="text/javascript">
  $(document).ready( function () {
      ...
      table = $('#table_biaya').DataTable({ 
        "processing": true, 
        "serverSide": true, 
        "order": [],
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": "<?php echo base_url('trueaccon2194/rpp_rpk/load_all_serverside_laporan_biaya')?>",
            "type": "POST",
            "data": function ( data ) {
...
<div class="page-title"> 
  ...
  <div class="page-breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url('trueaccon2194/rpp_rpk')?>">RPP / RPK</a></li>
      <li class="active"><a href="#">Laporan biaya</a></li>
    </ol>
  </div>
</div>
<div id="main-wrapper">
<div class="row">
<div class="col-md-12">
  <a  href="<?php echo base_url('trueaccon2194/rpp_rpk/input_biaya_by_excel');?>" style="margin-right:10px;margin-bottom:10px;" class="btn btn-success pull-left"><i class="glyphicon glyphicon-plus"></i> Input Biaya By Excel</a><br><br><br>
</div>
<?php 
...
<div id="pesan"></div>
  <table id="table_biaya" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%" style="box-shadow:0px 0px 8px 0px #bababa;">
            <thead>
                <tr style="background-color:#34425a;color:white;">
                    ...
                    <th style="text-align:center;">Keterangan Biaya</th>
