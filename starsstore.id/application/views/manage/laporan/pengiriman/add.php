 ...
 <script type="text/javascript">
  ...
  $(document).ready( function () { 
    ...
    $("#invoice").change(function(){ 
        ...
        $.ajax({
            type : "POST",
            url  : baseURL + "trueaccon2194/laporan_pengiriman/getongkirlabel",
            data : {inv : inv},
            beforeSend: function(){
                $('#ongkirlabel').html("sedang memuat data...");
            },
            success : function(ok){
                $("#ongkirlabel").html(ok);
            }
...
<div class="page-title">
  ...
  <div class="page-breadcrumb">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Input Actual Tarif</li>
      ...
      <div class="row">
        <div class="col-md-6 col-xs-12" style="margin-bottom: 10px;">
            <div class="tab-content" style="padding: 10px;box-shadow:0px 0px 8px 0px #bababa;">
              ...
              <?php echo form_open_multipart('trueaccon2194/laporan_pengiriman/proses_input_actual', array('id'=>'form_produk_add'));?>
                  <div class="row">
                    <div class="col-md-12"><h3 style="margin-top: 0;">Input Per Invoice</h3></div>
                    <div class="col-md-12 input group">

                      <label>Invoice : </label> <i style="color:red;">*</i>

                      <select class="form-control cek_odv" name="invoice" id="invoice" required>

                        <option value="">-- pilih --</option>

                        <?php foreach($get_list as $g){?>

                          <option value="<?php echo $g->no_order_ex?>"><?php echo $g->invoice?> [<?php echo $g->buy_in?>] - <?php echo date('d/m/Y', strtotime($g->tanggal_order))?></option>

                        <?php }?>

                      </select>
                      <br>
                      <div id="ongkirlabel" style="color:red"></div>
                    </div>
                  ...
                  <button type="submit" class="simpan_review btn btn-success">Simpan</button><br><br>
              <?php echo form_close();?>
              </div>
              ...
              <?php echo form_open_multipart('trueaccon2194/laporan_pengiriman/proses_input_actual_massal', array('id'=>'form_produk_add'));?>
                  <div class="row">
                    ...
                    <div class="col-md-12 input group">
                      ...
                      <label>Tarif Actual : <i style="color:red;">*jika diisi kosong, maka tarif tidak akan diupdate</i></label>

                      <div class="input-group">

                      <span class="input-group-addon">Rp.</span>

                      <input id="tarif" type="number" name="tarif" class="form-control cek_retail" id="retail" placeholder="Tarif">
