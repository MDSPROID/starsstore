...
<?php echo form_open('trueaccon2194/media_promosi/update_banner_selain_utama')?>
                    ...
                    <div class="post-inv">                                        
                        <div class="row">
                            <div class="col-md-6 col-xs-12 input group">
                              ...
                              <input type="hidden" name="idbn" class="form-control cek_stat" value="<?php $a = $this->encrypt->encode($g['id_banner']); $b = base64_encode($a); echo $b?>" required>
                              <select class="form-control cek_odv" name="posisi" required>
                                <option value="<?php echo $g['posisi']?>"><?php echo $g['posisi']?></option>
                              </select>
                              <br>
                            </div>
                            <div class="col-md-6 col-xs-12 input group">
                              <label>Jenis Banner :<i style="color:red;">*</i></label>
                              <select class="form-control cek_odv" name="jenis" id="jenis_banner111" required>
                                <?php 
                                $j = "gambar";
                                if($j == $g['jenis']){?>
                            ...
                            <div class="col-md-6 col-xs-12 input group">
                              ...
                              <div class="input-group">
                                <input type="text" name="banner" class="form-control cek_stat" value="<?php echo $g['banner']?>" id="carfID" required>
                              ...
                              <i style="font-size: 10px;">Ex : https://www.youtube.com/watch?v=<i style="color: red">m8AGFn87Xmg</i></i>
                              <br>
                            </div>
                            <?php if($g['posisi'] == "utama_4" || $g['posisi'] == "utama_5"){?>
                            <div class="col-md-6 col-xs-12 input group">
                              <label>Banner Mobile Version :<i style="color:red;">*</i></label>
                              <div class="input-group">
                                <input type="text" name="bannermobile" class="form-control cek_stat" value="<?php echo $g['for_banner3']?>" id="carfID1" required>
                            ...
                            <div class="col-md-6 col-xs-12 input group">
                              ...
                              <input type="text" name="url" class="form-control cek_slug" id="col_url" value="<?php echo $g['link']?>"  placeholder="URL / Link" required>
                              <br>
                            </div>                          
                            <div class="col-md-6 input group">
                              ...
                              <input id="amount" type="number" name="perclick" value="<?php echo $g['perclick']?>"  class="form-control cek_retail" id="retail" value="0" placeholder="Harga Perclick" >
                              </div>
                              <?php if($g['posisi'] == "utama_4" || $g['posisi'] == "utama_5"){?>
                                <br>
                              <?php }?>
                             ...
                             <div class="col-md-6 col-xs-12 input group">
                              ...
                              <input type="text" name="ket" class="form-control cek_nama" value="<?php echo $g['ket']?>"  placeholder="Keterangan" required>
                              <br>
                            </div>
                            <div class="col-md-6 col-xs-12 input group">
                              <label>Tanggal Mulai :<i style="color:red;">*</i></label>
                                <div id="datetimepicker" class="input-append">
                                  <input type="text" data-format="yyyy-MM-dd" name="tgl_mulai" value="<?php echo $g['tgl_mulai']?>"  class="form-control cek_tgl" placeholder="Tanggal Mulai" required>
                                  <span class="add-on">
                            ...
                            <div class="col-md-6 col-xs-12 input group">
                              <label>Tanggal Akhir :<i style="color:red;">*</i></label>
                                <div id="datetimepicker2" class="input-append">
                                  <input type="text" data-format="yyyy-MM-dd" name="tgl_akhir" value="<?php echo $g['tgl_akhir']?>"  class="form-control cek_tgl" placeholder="Tanggal Berakhir" required>
                                  <span class="add-on">
                                    <i style="font-size: 18px;position: absolute;top: 30px;right: 20px;" data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                                  </span>   
                                </div>
  ...
  <div class="col-md-3 col-xs-12">
    <div class="panel panel-primary" style="border-color:#d3d3d3;">
        ...
        <div class="panel-body" style="box-shadow:0px 0px 8px 0px #bababa;">
          ...
          <button type="submit" class="btn btn-success" onclick="simpan_promo()">Update Banner</button>
          <?php echo br(2)?>
      </div>
      </div>
  </div>
