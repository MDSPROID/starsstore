...
<?php echo form_open('trueaccon2194/media_promosi/update_banner_utama')?>
                    ...
                    <div class="post-inv">                                        
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xs-12 input group">
                              ...
                              <input type="text" name="url" class="form-control cek_slug" value="<?php echo $g['link']?>"  placeholder="URL / Link" required>
                              <br>
                            </div>
