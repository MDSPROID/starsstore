...
<!-- Notification 1  -->
<div style="display: none" id="element_023448897525668144"></div><!-- End Notification 1 -->

<!-- Notification 2  -->
<div style="display: none" id="element_04133982225321233"></div><!-- End Notification 2 -->

<!-- Notification 3 -->
<div style="display: none" id="element_07643384840339422"></div><!-- End Notification 3 -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full"  bgcolor="#f5f5f5"style="background-color: #f5f5f5;">
  <tr>
    <td style="background-image: url('https://www.starsstore.id/assets/images/ic_email/not3_bg_image.jpg'); -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; background-position: center center; background-repeat: no-repeat;" id="not4">
              ...
              <tr>
                <td width="352" valign="middle" align="center">
                  ...
                  <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                    <tr>
                      <td valign="middle" width="352" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 67px; color: #383838; line-height: 72px; font-weight: 100; word-break: break-all;"class="fullCenter" >
                        <!--[if !mso]><!--><span style="font-family: 'proxima_novathin', Helvetica; font-weight: normal;"><!--<![endif]-->Hallo!<!--[if !mso]><!--></span><!--<![endif]-->
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile" object="drag-module-small">
              <tr>
                <td width="352" valign="middle" align="center">
                  ...
                  <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                    <tr>
                      <td valign="middle" width="100%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 19px; color: #383838; line-height: 26px; text-transform: uppercase;" class="fullCenter" >
                        <!--[if !mso]><!--><span style="font-family: 'proxima_nova_rgbold', Helvetica;"><!--<![endif]-->Pendaftaran Berhasil!<!--[if !mso]><!--></span><!--<![endif]-->
                      </td>
                    </tr>
                    <tr>
        ...
        <tr>
          ...
          <td align="center" width="352" valign="middle">
            ...
            <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="full">
              <tr>
                <td align="center" width="352" valign="middle" bgcolor="#83af9a"style="background-color: rgb(131, 175, 154);">
                
                  <div class="sortable_inner ui-sortable">
                  
                  <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile" bgcolor="#83af9a"object="drag-module-small" style="background-color: white;">
                    <tr>
                      <td width="352" valign="middle" align="center">
                  ...
                  <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile" bgcolor="#83af9a"object="drag-module-small" style="background-color: white;">
                    <tr>
                      <td width="352" valign="middle" class="avatar125" align="center">
                        ...
                        <table width="265" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                          <tr>
                            <td width="100%"><span ><img style="border-radius: 60px;" src="https://www.starsallthebest.com/new/assets/images/img/default.png" width="125" alt="" border="0" ></span></td>
                          </tr>
                        </table>              
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td width="352" valign="middle" align="center">
                        ...
                        <table width="265" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                          ...
                          <tr>
                            <td valign="middle" width="100%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 34px; color: #383838; line-height: 44px; font-weight: bold;"class="fullCenter" >
                              <!--[if !mso]><!--><span style="font-family: 'proxima_novalight', Helvetica; font-weight: normal;"><?php echo $nakap?></span><!--<![endif]-->
                            </td>
                          </tr>
                        </table>
                      </td>
                  ...
                  <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile" bgcolor="#83af9a"object="drag-module-small" style="background-color:white;">
                    <tr>
                      <td width="352" valign="middle" align="center">
                        ...
                        <table width="265" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                          <tr>
                            <td valign="middle" width="100%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #383838; line-height: 24px;"class="fullCenter" >
                              <!--[if !mso]><!--><span style="font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;"><!--<![endif]--><?php echo $info?><!--[if !mso]><!--></span><!--<![endif]-->
                            </td>
                          </tr>
                        </table>
                      </td>
                  ...
                  <!----------------- Button Center ----------------->
                  <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile" bgcolor="#83af9a"object="drag-module-small" style="background-color: #d80e0e;">
                    <tr>
                      <td width="352" valign="middle" align="center">
                        ...
                        <table width="300" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                          ...
                          <tr>
                            <td align="center">
                              <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top:20px;margin-bottom:10px;"> 
                                <tr> 
                                  <td align="center" height="45"bgcolor="#ffffff" style="border-top-left-radius: 5px; border-top-right-radius: 5px; border-bottom-right-radius: 5px; border-bottom-left-radius: 5px; padding-left: 30px; padding-right: 30px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; color: rgb(56, 56, 56); text-transform: uppercase; background-color: rgb(255, 255, 255);">
                                    <!--[if !mso]><!--><span style="font-family: 'proxima_nova_rgbold', Helvetica; font-weight: normal;"><!--<![endif]-->
                                      <a href="<?php echo base_url('customer');?>" style="color: rgb(56, 56, 56); font-size: 15px; text-decoration: none; line-height: 35px; width: 100%;">Profil Anda</a>
                                    <!--[if !mso]><!--></span><!--<![endif]-->
                                  </td> 
                                </tr> 
                              </table> 
                        ...
                        <table width="265" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                          <tr>
                            <td valign="middle" width="100%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 15px; color: rgb(255, 255, 255); line-height: 24px;"class="fullCenter" >
                              <!--[if !mso]><!--><span style="font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;"><!--<![endif]-->Selamat Berbelanja!<!--[if !mso]><!--></span><!--<![endif]--> <br>
                              <!--[if !mso]><!--><span style="font-family: 'proxima_nova_rgbold', Helvetica; font-weight: normal;"><!--<![endif]--><a href="<?php echo base_url();?>" style="color: rgb(255, 255, 255);">Klik disini</a><!--[if !mso]><!--></span><!--<![endif]-->
                            </td>
                          </tr>
                        </table>
                      </td>
                  ...
                  <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile" bgcolor="#83af9a"object="drag-module-small" style="background-color: #d80e0e;">
                    <tr>
                      <td width="352" valign="middle">
                        ...
                        <table width="265" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                          <tr>
                            <td width="100%" height="50" style="font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal; color: white"><span><a href="<?php echo base_url('bantuan/cara-belanja');?>" style="color: white; text-decoration: none;">Cara Belanja</a></span> | <span><a href="<?php echo base_url('bantuan');?>" style="color: white; text-decoration: none;">Hubungi Kami</a></span>
                            </td>
                          </tr>
                        </table>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile2">
        <tr>
          <td width="100%" align="center">
            ...
            <!-- CopyRight -->
            <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small" style="padding-top: 20px;">
              <tr>
                <td align="center" width="352" height="10"><table border="0" cellpadding="0" cellspacing="0">
              <tbody><tr>
                <td valign="top">
                  <table align="left" border="0" cellpadding="0" cellspacing="0" class="themezyFollowStacked">
                      <tbody><tr>
                          <td align="center" valign="top" class="themezyFollowIconContent" style="padding-right:10px; padding-bottom:9px;">
                              <a href="https://www.facebook.com/starsallthebest" target="_blank"><img src="<?php echo base_url('assets/images/ic_email/icon-facebook.png');?>" alt="Facebook" class="themezyFollowBlockIcon" width="30" style="width:30px; max-width:30px; display:block;"></a>
                          </td>
                      </tr>
                  </tbody></table>
                  <table align="left" border="0" cellpadding="0" cellspacing="0" class="themezyFollowStacked">
                      <tbody><tr>
                          <td align="center" valign="top" class="themezyFollowIconContent" style="padding-right:10px; padding-bottom:9px;">
                              <a href="http://www.twitter.com/starsallthebest" target="_blank"><img src="<?php echo base_url('assets/images/ic_email/icon-twitter.png');?>" alt="Twitter" class="themezyFollowBlockIcon" width="30" style="width:30px; max-width:30px; display:block;"></a>
                          </td>
                      </tr>
                  </tbody></table>
                  <table align="left" border="0" cellpadding="0" cellspacing="0" class="themezyFollowStacked">
                      <tbody><tr>
                          <td align="center" valign="top" class="themezyFollowIconContent" style="padding-right:0; padding-bottom:9px;">
                              <a href="https://www.instagram.com/stars.footwear" target="_blank"><img src="<?php echo base_url('assets/images/ic_email/icon-instagram.png');?>" alt="Instagram" class="themezyFollowBlockIcon" width="30" style="width:30px; max-width:30px; display:block;"></a>
                          </td>
                      </tr>
                  </tbody>
                </table>
            ...
            <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
              <tr>
                <td valign="middle" width="352" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 13px; color: #717171;"class="fullCenter"  align="center">
                  <span ><!--[if !mso]><!--><span style="line-height: 20px;font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;"><!--<![endif]-->Anda menerima email ini karena anda telah mendaftar diwebsite kami. <!--[if !mso]><!--></span><!--<![endif]--></span><br><br>
                  <span style="font-size: 12px;line-height: 20px;"><a href="<?php echo base_url('bantuan/kebijakan-privasi');?>" style="text-decoration: none; color: #717171;">Kebijakan Privasi</a> | <a href="<?php echo base_url('bantuan/syarat-dan-ketentuan');?>" style="text-decoration: none; color: #717171;">Syarat dan Ketentuan</a> | <a href="#" style="text-decoration: none; color: #717171;">Unsubscribe</a></span>
                   <br><br>
                  <!--[if !mso]><!--><span><!--<![endif]--><!--subscribe--><?php $get_data_setting_footer = for_footer();?>
                        <?php foreach($get_data_setting_footer as $data){?><?php echo $data->konten?><?php }?> Hak Cipta Dilindungi.<!--unsub--><!--[if !mso]><!--></span><!--<![endif]-->
                </td>
              </tr>
            </table>
            <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
...
<!-- Notification 5 -->
<div style="display: none" id="element_07820815613958985"></div><!-- End Notification 5 -->

<!-- Notification 6 -->
<div style="display: none" id="element_01404779558070004"></div><!-- End Notification 6 -->
</div>
