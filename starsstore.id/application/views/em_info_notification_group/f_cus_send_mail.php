...
<body style="background-color: #f5f5f5;
  ...
  <table style="border-collapse: collapse;"  width="100%" border="0" cellpadding="0" class="full" cellspacing="0" align="center">
  <tr>
    <td>
    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
      <tr>
        <td width="600">
      <div class="col-md-12" style="padding:15px;color: #4e4e4e;background-color: white;"><?php echo $isi?></div>
      </td>
      </tr>
    </table>
      </td>
            ...
            <table width="600" border="0" style="margin-bottom:20px;" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
              <tr>
                <td valign="middle" width="600" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 13px; color: #717171;"class="fullCenter"  align="center">
                  <span style="font-size: 12px;line-height: 20px;"><a href="<?php echo base_url('bantuan/kebijakan-privasi');?>" style="text-decoration: none; color: #717171;">Kebijakan Privasi</a> | <a href="<?php echo base_url('bantuan/syarat-dan-ketentuan');?>" style="text-decoration: none; color: #717171;">Syarat dan Ketentuan</a></span>
                   <br><br>
