...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full"  bgcolor="#f5f5f5"style="background-color: #f5f5f5;">
  <tr>
    <td style="background-image: url('../assets/images/ic_email/not3_bg_image.jpg'); -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; background-position: center center; background-repeat: no-repeat;" id="not4">
                    ...
                    <tr>
                      <td valign="middle" width="352" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 67px; color: #383838; line-height: 72px; font-weight: 100; word-break: break-all;"class="fullCenter" >
                        ...
                        <?php foreach($get_data_setting as $data):?>
                            <img src="<?php echo base_url('assets/images/')?><?php echo $data->konten;?>" style="width:100px;height: auto">
                        <?php endforeach;?><!--[if !mso]><!--></span><!--<![endif]-->
                      </td>
                    </tr>
                  </table>
                </td>
                  ...
                  <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                    <tr>
                      <td valign="middle" width="100%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 19px; color: #383838; line-height: 26px; text-transform: uppercase;" class="fullCenter" >
                        <!--[if !mso]><!--><span style="font-family: 'proxima_nova_rgbold', Helvetica;"><!--<![endif]--><!--[if !mso]><!--></span><!--<![endif]-->
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td width="352" valign="middle" class="avatar125" align="center">
                        ...
                        <table width="265" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                          <tr>
                            <td width="100%"><span ><img style="border-radius: 60px;" src="<?php echo base_url('assets/images/img/default.png');?>" width="125" alt="" border="0" ></span></td>
                          </tr>
                        </table>              
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td width="352" valign="middle" align="center">
                        ...
                        <table width="265" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                          ...
                          <tr>
                            <td valign="middle" width="100%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 15px; color: #383838; line-height: 44px; font-weight: bold;"class="fullCenter" >
                              <!--[if !mso]><!--><span style="font-family: 'proxima_novalight', Helvetica; font-weight: normal;">Hai, <?php echo $nama?></span><!--<![endif]-->
                            </td>
                          </tr>
                        </table>
                      </td>
                  ...
                  <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile" bgcolor="#83af9a"object="drag-module-small" style="background-color:white;">
                    <tr>
                      <td width="352" valign="middle" align="center">
                        <table width="265" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                          <tr>
                            <td valign="middle" width="100%" style="text-align:justify; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #383838; line-height: 24px;padding: 10px;"class="fullCenter" >
                              <!--[if !mso]><!--><span style="font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;"><!--<![endif]--><?php echo $isi_pesan;?><!--[if !mso]><!--></span><!--<![endif]-->
                            </td>
                          </tr>
                        </table>
                      </td>
           ...
           <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
              <tr>
                <td valign="middle" width="352" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 13px; color: #717171;"class="fullCenter"  align="center">
                  <span ><!--[if !mso]><!--><span style="line-height: 20px;font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;"><!--<![endif]-->Anda menerima email ini karena anda telah mengajukan retur diwebsite kami. <!--[if !mso]><!--></span><!--<![endif]--></span><br><br>
