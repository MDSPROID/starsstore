...
<meta name="description" content="invoice pembelanjaan" />
<meta charset="utf-8" />
...
<div class="bg-parallax-1" style="background-color: #f5f5f5;">
	<div class="container product-content text-center" style="margin-bottom:20px;margin-top: 25px;">
		...
		<div class="col-md-6 col-xs-12">
			...
			<h3 style="margin-bottom: 30px;">Aplikasi Untuk Toko Stars</h3>			
			<div class="input-group">
		        ...
		        <input type="text" name="inv" class="form-control list-form" id="inv" placeholder="Masukkan Nomor pesanan / Invoice" required>
            	<span class="input-group-btn">
            		<button class="btn btn-danger mail_sb hj" style="border:1px solid black;color:black;" onclick="cariInv();">Cari</button>
            	</span>
            </div>
