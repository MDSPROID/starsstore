			...
			<main id="mt-main">
				...
				<div class="container">
					<div class="row">
						...
						<aside id="sidebar" class="sidebar-filter sidebar-filter-row col-xs-12 col-sm-4 col-md-3 wow fadeInLeftx" data-wow-delay="0.4s">
							...
							<section class="shop-widget filter-widget bg-grey" style="padding: 16px 20px;">
								...
								<span class="sub-title">Merk</span>
								<div class="pd-filter">
