...
<meta name="description" content="Cek Estimasi Ongkir" />
<meta name="keywords" content="Cek Estimasi Ongkir"/>
<meta charset="utf-8" />
...
<div class="bg-lupa-password" style="background-color: #f5f5f5;padding-top: 10px !important;s">
	<div class="container product-content text-center" style="margin-bottom:20px;margin-top: 25px;">
		...
		<div class="col-md-6 col-xs-12">
			...
			<h3>Cek Estimasi Ongkir</h3>
			<div id="gdongkir-widget"></div><script type="text/javascript" src="//ongkos-kirim.com/gdwidget/gdwongkir.js"></script>
		</div>
		<div class="col-md-3 col-xs-12"></div>
	</div>
</div>
