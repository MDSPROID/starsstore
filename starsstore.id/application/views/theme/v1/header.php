	...
	<div id="mySidenav" class="sidenav"> 
		<div class="head-side-menu text-center">
			<div class="top-menu-slide">
				<label class="inf-log">MENU</label>
	  	...
	  	<div class="menu-menu">						
	  		<ul class="list-unstyled menu-tab1">
				...
				<li>
					<a href="<?php echo base_url('terbaru/highlight');?>">NEW ARRIVAL</a>
				</li>
				...
				<li>
					...
					<section class="shop-widget filter-widget bg-grey" style="padding: 0 15px 0 0;background-color: transparent;border: none;margin-top: 8px;margin-bottom: 10px;">
						<span class="sub-title warna-btn nav-btn">BRAND <i class="fa fa-chevron-right pull-right"></i></span>
						<div class="pd-filter warna-filter" style="display: none;margin-bottom: 10px;">
							<?php
                                $merk = for_header_front_end_merk();
                                foreach($merk as $x){
                                ?>
									<div style="margin-left: 15px;text-transform: uppercase;"><a href="<?php echo base_url('merk/'.$x->slug.'');?>"><?php echo $x->merk;?></a></div>
                            <?php }?>
						</div>
                        ...
                        ?>							
							<?php if($t->kat_id == 37){?>
							<span class="sub-title harga-btn nav-btn">
								<a onclick="javascript:location.href='<?php echo base_url('kategori/'.$t->slug.'');?>'" href="javascript:void(0);" style="text-transform: uppercase;">
								<?php echo $t->kategori?>
							...
							<?php 
                                ...
                                foreach($get_pk as $y){
                            ?>
							<div class="price-range pd-filter harga-filter" style="display: none;margin: 0;padding-bottom: 0;border-bottom: none;">
								<div style="margin-left: 15px;text-transform: uppercase;">
									<a href="<?php echo base_url('sub-kategori/'.$y->slug_parent.'');?>"><?php echo $y->parent_kategori?></a>
								</div>
							</div>
							<?php }?>
							<?php }?>
							...
							<?php if($t->kat_id == 26){?>
							<span class="sub-title ukuran-btn nav-btn"><a onclick="javascript:location.href='<?php echo base_url('kategori/'.$t->slug.'');?>'" style="text-transform: uppercase;" href="javascript:void(0);"> <?php echo $t->kategori?> 
								</a> <i class="fa fa-chevron-right pull-right"></i>
							</span>
							<?php 
                                // get parent kategori 
                                ...
                                foreach($get_pk as $y){
                            ?>
							<div class="pd-filter ukuran-filter" style="display: none;margin: 0;padding-bottom: 0;border-bottom: none;">
								<div style="margin-left: 15px;text-transform: uppercase;">
									<a href="<?php echo base_url('sub-kategori/'.$y->slug_parent.'');?>"><?php echo $y->parent_kategori?></a>
								</div>
							</div>
							...
							<?php if($t->kat_id == 34){?>
							<span class="sub-title merk-btn nav-btn">
								<a style="text-transform: uppercase;" onclick="javascript:location.href='<?php echo base_url('kategori/'.$t->slug.'');?>'" href="javascript:void(0);"> <?php echo $t->kategori?>
								</a> <i class="fa fa-chevron-right pull-right"></i>
							</span>
							<?php 
                                // get parent kategori 
                                ...
                                foreach($get_pk as $y){
                            ?>
							<div class="pd-filter merk-filter nav-btn" style="display: none;margin: 0;padding-bottom: 0;border-bottom: none;">
								<div style="margin-left: 15px;text-transform: uppercase;">
									<a href="<?php echo base_url('sub-kategori/'.$y->slug_parent.'');?>"><?php echo $y->parent_kategori?></a>
								</div>
							</div>
				...
				<li style="display: none;"><a href="<?php echo base_url('tentang-kami');?>">TENTANG KAMI</a></li>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-xs-12">
								...
								<!-- mt logo start here -->
								<div class="mt-logo hidden-xs">
									<a href="<?php echo base_url();?>">
										<?php $get_data_setting = for_header_front_end();?>
						    			<?php foreach($get_data_setting as $data):?>
											<img src="<?php echo base_url('assets/images/')?><?php echo $data->konten;?>" alt="loader">
										<?php endforeach;?>	
									</a>
								</div>
								...
								<nav id="nav">
									<ul>
										<li>
											<a href="<?php echo base_url();?>">HOME <i class="fa fa-angle-down hidden-lg hidden-md" aria-hidden="true"></i></a>
										</li>
										<li><a href="<?php echo base_url('terbaru/highlight');?>">NEW ARRIVAL</a></li>
										<li style="display: none;"><a href="<?php echo base_url('promo-menarik');?>">PROMO</a></li>
										<li class="drop">
											<a href="javascript:void(0);">KATEGORI <i class="fa fa-angle-down" aria-hidden="true"></i></a>
											...
											<div class="mt-dropmenu text-left">
												...
												<div class="mt-frame">
													...
													<div class="mt-f-box">
														<!-- mt col3 start here -->
														<div class="mt-col-3 col-md-4" style="width: 33.33333333%;">
														<?php
                                                        $kat = for_header_front_end_kategori();
                                                        foreach($kat as $t){
                                                        ?>
															<div class="sub-dropcont">
																<a onclick="javascript:location.href='<?php echo base_url('kategori/'.$t->slug.'');?>'" href="javascript:void(0);" class="mt-subopener">
																	<strong class="title"><?php echo $t->kategori?></strong>
																</a>
																<div class="sub-drop">
																	<ul>
																		<?php 
														...
														<div class="mt-col-3 col-md-3" style="width: 25%;">
															<div class="sub-dropcont">
																<strong class="title"><a href="#" class="mt-subopener">BRAND</a></strong>
																<div class="sub-drop">
																	<ul>
																		<?php
				                                                        $merk = for_header_front_end_merk();
				                                                        foreach($merk as $x){
				                                                        ?>
																			<li><a href="<?php echo base_url('merk/'.$x->slug.'');?>"><?php echo strtoupper($x->merk);?></a></li>
				                                                        <?php }?>
				                                                	</ul>
																</div>
	                                                        </div>
														...
														<!-- mt col3 start here -->
														<div class="mt-col-3 col-md-5 promo" style="width: 41.66666667%;"> 
															<div class="mt-promobox">
																<?php
			                                                        $banner_promo = for_header_front_end_banner_nav();
			                                                        foreach($banner_promo as $i){
		                                                        ?>
																<a href="#"><img src="<?php echo $i->banner;?>" alt="promo banner" class="img-responsive"></a>
																<?php }?>
															</div>
														</div>
													</div>
