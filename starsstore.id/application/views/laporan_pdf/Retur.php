	...
	function load_all_serverside(){
		...
		foreach($list_data as $x){
		    ...
		    if($x->id_invoice_pengganti == 0){
		    	...
		    	$invoicepengganti = $x->id_invoice_pengganti." - ".$status;
		    }
		    ...
		    if($x->solusi == 1){
          	...
          	$row[] = $x->id_retur_info."<br>".$buy;
          	$row[] = "Invoice Retur :<br><i><b>".$x->id_invoice_real." - ".$status."</i></b><br><br>Invoice Pengganti :<br><i><b>".$invoicepengganti."</i></b>";
          	$row[] = $x->alasan;
          	$row[] = $solusi;
