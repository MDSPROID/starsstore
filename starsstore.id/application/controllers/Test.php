...
class Test extends CI_Controller {
	...
	public function __construct($url = "https://api-staging.lazada.co.id/",$appkey = "105111",$secretKey = "kfOSBqWNi6BpImpJysNEN3lQ06bojKCG")
	{
		$this->load->library(array('Constants'));
		$length = strlen($url);
	    if($length == 0)
	    {    
