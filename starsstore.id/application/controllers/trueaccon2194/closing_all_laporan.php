...
<div class="row">
  <div class="col-md-12">
    <div class="tab-content">
      ...
      <div id="PRODUK" class="col-md-12" style="text-align: center;">
            ...
            <tbody>
                ...
                foreach($laporan_retur as $rtr){
                  ...
                  if($rtr->id_invoice_pengganti == 0){ 
                    ...
                    $invoicepengganti = $rtr->id_invoice_pengganti." - ".$status;
                  }
                ?>
               ...
               <tr style="border:1px solid #000;">
                  ...
                  <td style="text-align:left;border:1px solid #000;font-size: 12px;">
                    <?php 
                      echo "Invoice Retur :<br><i><b>".$rtr->id_invoice_real." - ".$status."</i></b><br><br>Invoice Pengganti :<br><i><b>".$invoicepengganti."</i></b>";
                    ?>
                  </td>
        ...
        <div class="row page-break">
          ...
          <div class="col-md-12 table-responsive" style="margin-top: 20px;"> 
            ...
            foreach($getStore as $store){
              ...
              $rekapOrder = $this->rpp_rpk_adm->get_order_for_comission($storeEdp,$tgl1,$tgl2);
              ...
              <tbody>
                  ...
                  foreach($rekapOrder as $data5){
                    ...
                    if($data5->komisi_toko == ""){
                      $komisi3 = ($data5->harga_fix*5)/100;
                    }else{
                      $komisi3 = $data5->komisi_toko;
                    }
                 ...
                 <tr style="border:1px solid #000;">
                    ...
                    <td style="text-align:center;border:1px solid #000;font-size: 12px;">
                      Rp. <?php echo number_format($data5->harga_fix,0,".",".");?><br>
                      <i style="color: red;font-size: 10px;">
