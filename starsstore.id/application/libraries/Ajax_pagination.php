...
class Ajax_pagination{
    ...
    var $last_link       = 'Last';
    var $uri_segment     = 3;
    var $full_tag_open   = '<ul style="margin-top:20px;" class="pagination text-right">';
    ...
    function create_links(){
        ...
        if ($this->show_count){
            ...
            $info = 'Menampilkan ' . ( $curr_offset + 1 ) . ' - ' ;
        ...
        function searchFilter(page_num){  
            ...
            $.ajax({
                method: "POST",
                url: "<?php echo $this->base_url; ?>"+page_num, //'&rating='+rating+
                data:'page='+page_num+'&minH='+minH+'&maxH='+maxH+'&bds='+bdsk+'&ftj='+tipe_kategori+'&sortBy='+sortBy+'&size='+size+'&colour='+colour+'&brand='+brand+'&fscurepro21=' + csrf,
                beforeSend: function(){
        ...
        function searchFilterx(page_num){  
            alert("test");
        }
        </script>
        <?php
